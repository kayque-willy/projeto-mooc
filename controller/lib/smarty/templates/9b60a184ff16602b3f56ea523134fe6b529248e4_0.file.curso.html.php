<?php
/* Smarty version 3.1.29, created on 2016-10-08 17:35:15
  from "/home/ubuntu/workspace/view/curso.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57f92e53b20362_57783541',
  'file_dependency' => 
  array (
    '9b60a184ff16602b3f56ea523134fe6b529248e4' => 
    array (
      0 => '/home/ubuntu/workspace/view/curso.html',
      1 => 1475948113,
      2 => 'file',
    ),
  ),
...
function content_57f92e53b20362_57783541 ($_smarty_tpl) {
if (!is_callable('smarty_modifier_date_format')) require_once '/home/ubuntu/workspace/controller/lib/smarty/libs/plugins/modifier.date_format.php';
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
&pagina=Pagina Inicial" class="btn btn-lg btn-primary">Ver curso</a> </div>
        <?php } else { ?>
        	 <?php if (!$_smarty_tpl->tpl_vars['inscrito']->value) {?>
          	 <?php if (($_smarty_tpl->tpl_vars['sessao']->value['tipo_usuario'] == 'tutor') || ($_smarty_tpl->tpl_vars['sessao']->value['tipo_usuario'] == 'admin')) {?>
               <div class="navbar-form text-center"> <a href="index.php?ctrl=classroom&ac=pagina&curso=<?php echo $_smarty_tpl->tpl_vars['curso']->value[0]['numero'];?>
&pagina=Pagina Inicial" class="btn btn-lg btn-primary">Ver curso</a> </div>
             <?php } else { ?>
...
&pagina=Pagina Inicial" class="btn btn-lg btn-success">Ir para o curso</a> </div>
    ...
    <session class="col-md-6"> 
      <!--Visão geral-->
      <article id="sec0">
        <h1 class="text-justify"><?php echo $_smarty_tpl->tpl_vars['curso']->value[0]['nome'];?>
</h1>
...
">
        ...
        <hr>
        	<?php if ($_smarty_tpl->tpl_vars['curso']->value[0]['video'] != 'NULL' && !empty($_smarty_tpl->tpl_vars['curso']->value[0]['video'])) {?>
