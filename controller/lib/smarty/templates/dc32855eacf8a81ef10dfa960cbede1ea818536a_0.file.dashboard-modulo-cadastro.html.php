<?php
/* Smarty version 3.1.29, created on 2016-09-20 02:52:32
  from "D:\xampp\www\mooc\view\dashboard-modulo-cadastro.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57e0885094be89_80484913',
  'file_dependency' => 
  array (
    'dc32855eacf8a81ef10dfa960cbede1ea818536a' => 
    array (
      0 => 'D:\\xampp\\www\\mooc\\view\\dashboard-modulo-cadastro.html',
      1 => 1474332647,
      2 => 'file',
    ),
  ),
...
function content_57e0885094be89_80484913 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
.jpg <?php } else { ?>http://www.freeiconspng.com/uploads/no-image-icon-13.png<?php }?>"  width="50"/><br>
                      ...
                      <fieldset class="row form-group">
                        ...
                        <div class="col-md-10">
                          <div class="row ">
                          <?php if (!empty($_smarty_tpl->tpl_vars['modulo']->value[0]['video'])) {?>
...
" frameborder="0" allowfullscreen></iframe>
                          ...
                          <?php }?>  
                            <hr>
                            <div class="col-md-12">
                              <input id="video" name="video" type="text" placeholder="Url do video" class="form-control input-md" <?php if (!empty($_smarty_tpl->tpl_vars['modulo']->value[0]['video'])) {?> value="<?php echo $_smarty_tpl->tpl_vars['modulo']->value[0]['video'];?>
" <?php }?>>
                            </div>
                          </div>
                        </div>
